...
// Check and submit the score for the current mode
    ...
    if (lowestScore === null || currentScore < lowestScore) {
        ...
        fetch('./php/leaderboard.php', {
            ...
            body: new URLSearchParams({
                ...
                mode: currentMode   // Pass the current game mode
            })
        })
            .then(response => {
                if (!response.ok) {
            ...
            .then(data => {
                if (data.status === 'success') {
                    ...
                    fetchLowestScore(); // Refresh the lowest score
                    loadLeaderboard(currentMode); // Reload the leaderboard
                } else {
...
// Load and display the leaderboard for the current mode
